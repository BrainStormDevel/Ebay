...
{
    /**
     * @param mixed A PHP object derived from BrainStorm\Ebay\Types\BaseType
    ...
    private static function assignProperties(\BrainStorm\Ebay\Types\BaseType $object, array $properties)
    {
