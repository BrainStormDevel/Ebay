...
namespace BrainStorm\Ebay\Parser;
...
class XmlParser
{
     ...
     *
     * @return mixed A PHP object derived from BrainStorm\Ebay\Types\BaseType
     */
    ...
    {
        return (
            is_subclass_of($meta->phpObject, '\BrainStorm\Ebay\Types\Base64BinaryType', false) ||
            is_subclass_of($meta->phpObject, '\BrainStorm\Ebay\Types\BooleanType', false) ||
            is_subclass_of($meta->phpObject, '\BrainStorm\Ebay\Types\DecimalType', false) ||
            is_subclass_of($meta->phpObject, '\BrainStorm\Ebay\Types\DoubleType', false) ||
            is_subclass_of($meta->phpObject, '\BrainStorm\Ebay\Types\IntegerType', false) ||
            is_subclass_of($meta->phpObject, '\BrainStorm\Ebay\Types\StringType', false) ||
            is_subclass_of($meta->phpObject, '\BrainStorm\Ebay\Types\TokenType', false) ||
            is_subclass_of($meta->phpObject, '\BrainStorm\Ebay\Types\URIType', false)
        );
    }
    ...
    {
        if (is_subclass_of($meta->phpObject, '\BrainStorm\Ebay\Types\Base64BinaryType', false)) {
            return $meta->strData;
        } elseif (is_subclass_of($meta->phpObject, '\BrainStorm\Ebay\Types\BooleanType', false)) {
            return strtolower($meta->strData) === 'true';
        } elseif (is_subclass_of($meta->phpObject, '\BrainStorm\Ebay\Types\DecimalType', false)) {
            return is_int(0 + $meta->strData) ? (integer)$meta->strData : (double)$meta->strData;
        } elseif (is_subclass_of($meta->phpObject, '\BrainStorm\Ebay\Types\DoubleType', false)) {
            return (double)$meta->strData;
        } elseif (is_subclass_of($meta->phpObject, '\BrainStorm\Ebay\Types\IntegerType', false)) {
            return (integer)$meta->strData;
        } elseif (is_subclass_of($meta->phpObject, '\BrainStorm\Ebay\Types\StringType', false)) {
            return $meta->strData;
        } elseif (is_subclass_of($meta->phpObject, '\BrainStorm\Ebay\Types\TokenType', false)) {
            return $meta->strData;
        } elseif (is_subclass_of($meta->phpObject, '\BrainStorm\Ebay\Types\URIType', false)) {
            return $meta->strData;
        }
