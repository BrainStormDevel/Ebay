 ...
 * @property \BrainStorm\Ebay\Trading\Enums\CountryCodeType $PhoneCountryCode
 * @property string $PhoneCountryPrefix
 * @property string $PhoneAreaOrCityCode
 * @property string $PhoneLocalNumber
 * @property \BrainStorm\Ebay\Trading\Enums\CountryCodeType $Phone2CountryCode
 * @property string $Phone2CountryPrefix
 * @property string $Phone2AreaOrCityCode
 * @property string $Phone2LocalNumber
 * @property string $PostalCode
 * @property string $AddressID
 * @property \BrainStorm\Ebay\Trading\Enums\AddressOwnerCodeType $AddressOwner
 ...
 * @property \BrainStorm\Ebay\Trading\Enums\AddressUsageCodeType $AddressUsage
 * @property string $ReferenceID
 * @property \BrainStorm\Ebay\Trading\Types\AddressAttributeType[] $AddressAttribute
 */
class AddressType extends \BrainStorm\Ebay\Types\BaseType
{
    /**
    ...
    private static $propertyTypes = [
        ...
        'AddressAttribute' => [
            'type' => 'BrainStorm\Ebay\Trading\Types\AddressAttributeType',
            'repeatable' => true,
            'attribute' => false,
