 ...
 * @property \BrainStorm\Ebay\Trading\Enums\DaysCodeType $Hours1Days
 * @property boolean $Hours1AnyTime
 * @property string $Hours1From
 * @property string $Hours1To
 * @property \BrainStorm\Ebay\Trading\Enums\DaysCodeType $Hours2Days
 * @property boolean $Hours2AnyTime
 * @property string $Hours2From
 * @property string $Hours2To
 */
class ContactHoursDetailsType extends \BrainStorm\Ebay\Types\BaseType
{
    /**
