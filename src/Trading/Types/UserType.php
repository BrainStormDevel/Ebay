 ...
 * @property \BrainStorm\Ebay\Trading\Enums\FeedbackRatingStarCodeType $FeedbackRatingStar
 * @property boolean $IDVerified
 * @property boolean $eBayGoodStanding
 * @property boolean $NewUser
 * @property \BrainStorm\Ebay\Trading\Types\AddressType $RegistrationAddress
 * @property \DateTime $RegistrationDate
 * @property \BrainStorm\Ebay\Trading\Enums\SiteCodeType $Site
 * @property \BrainStorm\Ebay\Trading\Enums\UserStatusCodeType $Status
 * @property string $UserID
 * @property boolean $UserIDChanged
 * @property \DateTime $UserIDLastChanged
 * @property \BrainStorm\Ebay\Trading\Enums\VATStatusCodeType $VATStatus
 * @property \BrainStorm\Ebay\Trading\Types\BuyerType $BuyerInfo
 * @property \BrainStorm\Ebay\Trading\Types\SellerType $SellerInfo
 * @property \BrainStorm\Ebay\Trading\Enums\BusinessRoleType $BusinessRole
 * @property \BrainStorm\Ebay\Trading\Enums\PayPalAccountLevelCodeType $PayPalAccountLevel
 * @property \BrainStorm\Ebay\Trading\Enums\PayPalAccountTypeCodeType $PayPalAccountType
 * @property \BrainStorm\Ebay\Trading\Enums\PayPalAccountStatusCodeType $PayPalAccountStatus
 * @property \BrainStorm\Ebay\Trading\Enums\EBaySubscriptionTypeCodeType[] $UserSubscription
 * @property boolean $eBayWikiReadOnly
 * @property integer $TUVLevel
 * @property string $VATID
 * @property boolean $MotorsDealer
 * @property \BrainStorm\Ebay\Trading\Types\BiddingSummaryType $BiddingSummary
 ...
 * @property \BrainStorm\Ebay\Trading\Types\AddressType $ShippingAddress
 * @property \BrainStorm\Ebay\Trading\Types\MembershipDetailsType $Membership
 * @property string $UserFirstName
 * @property string $UserLastName
 */
class UserType extends \BrainStorm\Ebay\Types\BaseType
{
    /**
    ...
    private static $propertyTypes = [
        ...
        'BuyerInfo' => [
            'type' => 'BrainStorm\Ebay\Trading\Types\BuyerType',
            'repeatable' => false,
            'attribute' => false,
            'elementName' => 'BuyerInfo'
        ],
        'SellerInfo' => [
            'type' => 'BrainStorm\Ebay\Trading\Types\SellerType',
            'repeatable' => false,
            'attribute' => false,
        ...
        'BiddingSummary' => [
            'type' => 'BrainStorm\Ebay\Trading\Types\BiddingSummaryType',
            'repeatable' => false,
            'attribute' => false,
        ...
        'Membership' => [
            'type' => 'BrainStorm\Ebay\Trading\Types\MembershipDetailsType',
            'repeatable' => false,
            'attribute' => false,
