 ...
 * @property \BrainStorm\Ebay\Trading\Enums\CurrencyCodeType $BillingCurrency
 ...
 * @property \BrainStorm\Ebay\Trading\Enums\SellerLevelCodeType $SellerLevel
 * @property \BrainStorm\Ebay\Trading\Types\AddressType $SellerPaymentAddress
 * @property \BrainStorm\Ebay\Trading\Types\SchedulingInfoType $SchedulingInfo
 * @property boolean $StoreOwner
 * @property string $StoreURL
 * @property \BrainStorm\Ebay\Trading\Enums\SellerBusinessCodeType $SellerBusinessType
 * @property boolean $RegisteredBusinessSeller
 * @property \BrainStorm\Ebay\Trading\Enums\SiteCodeType $StoreSite
 * @property \BrainStorm\Ebay\Trading\Enums\SellerPaymentMethodCodeType $PaymentMethod
 * @property boolean $CharityRegistered
 * @property boolean $SafePaymentExempt
 * @property integer $PaisaPayEscrowEMIStatus
 * @property \BrainStorm\Ebay\Trading\Types\CharityAffiliationDetailsType $CharityAffiliationDetails
 * @property double $TransactionPercent
 * @property \BrainStorm\Ebay\Trading\Types\IntegratedMerchantCreditCardInfoType $IntegratedMerchantCreditCardInfo
 * @property \BrainStorm\Ebay\Trading\Types\FeatureEligibilityType $FeatureEligibility
 * @property boolean $TopRatedSeller
 * @property \BrainStorm\Ebay\Trading\Types\TopRatedSellerDetailsType $TopRatedSellerDetails
 * @property \BrainStorm\Ebay\Trading\Types\RecoupmentPolicyConsentType $RecoupmentPolicyConsent
 * @property boolean $DomesticRateTable
 */
class SellerType extends \BrainStorm\Ebay\Types\BaseType
{
    /**
    ...
    private static $propertyTypes = [
        ...
        'SchedulingInfo' => [
            'type' => 'BrainStorm\Ebay\Trading\Types\SchedulingInfoType',
            'repeatable' => false,
            'attribute' => false,
        ...
        'CharityAffiliationDetails' => [
            'type' => 'BrainStorm\Ebay\Trading\Types\CharityAffiliationDetailsType',
            'repeatable' => false,
            'attribute' => false,
        ...
        'IntegratedMerchantCreditCardInfo' => [
            'type' => 'BrainStorm\Ebay\Trading\Types\IntegratedMerchantCreditCardInfoType',
            'repeatable' => false,
            'attribute' => false,
            'elementName' => 'IntegratedMerchantCreditCardInfo'
        ],
        'FeatureEligibility' => [
            'type' => 'BrainStorm\Ebay\Trading\Types\FeatureEligibilityType',
            'repeatable' => false,
            'attribute' => false,
        ...
        'TopRatedSellerDetails' => [
            'type' => 'BrainStorm\Ebay\Trading\Types\TopRatedSellerDetailsType',
            'repeatable' => false,
            'attribute' => false,
            'elementName' => 'TopRatedSellerDetails'
        ],
        'RecoupmentPolicyConsent' => [
            'type' => 'BrainStorm\Ebay\Trading\Types\RecoupmentPolicyConsentType',
            'repeatable' => false,
            'attribute' => false,
