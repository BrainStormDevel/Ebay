 ...
 * @property string $UPC
 * @property string $EAN
 * @property \BrainStorm\Ebay\Trading\Types\BrandMPNType $BrandMPN
 * @property \BrainStorm\Ebay\Trading\Types\TicketListingDetailsType $TicketListingDetails
 * @property boolean $UseFirstProduct
 * @property boolean $IncludeeBayProductDetails
 */
class ProductListingDetailsType extends \BrainStorm\Ebay\Types\BaseType
{
    /**
    ...
    private static $propertyTypes = [
        ...
        'BrandMPN' => [
            'type' => 'BrainStorm\Ebay\Trading\Types\BrandMPNType',
            'repeatable' => false,
            'attribute' => false,
            'elementName' => 'BrandMPN'
        ],
        'TicketListingDetails' => [
            'type' => 'BrainStorm\Ebay\Trading\Types\TicketListingDetailsType',
            'repeatable' => false,
            'attribute' => false,
